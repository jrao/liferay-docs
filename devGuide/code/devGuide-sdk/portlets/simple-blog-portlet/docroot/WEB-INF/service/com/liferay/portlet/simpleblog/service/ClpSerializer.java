...
import com.liferay.portlet.simpleblog.model.AuthorClp;
import com.liferay.portlet.simpleblog.model.PostClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"simple-blog-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "simple-blog-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.portlet.simpleblog.model.impl.AuthorImpl")) {
			return translateOutputAuthor(oldModel);
		}

		if (oldModelClassName.equals(
					"com.liferay.portlet.simpleblog.model.impl.PostImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new com.liferay.portlet.simpleblog.NoSuchAuthorException();
		}

		if (className.equals(
					"com.liferay.portlet.simpleblog.NoSuchPostException")) {
			return new com.liferay.portlet.simpleblog.NoSuchPostException();
		}
