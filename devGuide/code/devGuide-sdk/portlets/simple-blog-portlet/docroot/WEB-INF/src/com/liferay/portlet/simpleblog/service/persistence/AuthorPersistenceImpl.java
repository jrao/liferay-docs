...
import com.liferay.portlet.simpleblog.NoSuchAuthorException;
import com.liferay.portlet.simpleblog.model.Author;
import com.liferay.portlet.simpleblog.model.impl.AuthorImpl;
import com.liferay.portlet.simpleblog.model.impl.AuthorModelImpl;
...
public class AuthorPersistenceImpl extends BasePersistenceImpl<Author>
		...
		if (isNew || !AuthorModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((authorModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(authorModelImpl.getOriginalGroupId())
					};
				...
				args = new Object[] { Long.valueOf(authorModelImpl.getGroupId()) };
	...
	public List<Author> findByGroupId(long groupId, int start, int end,
		...
		if (list == null) {
			...
			try {
				...
				list = (List<Author>)QueryUtil.list(q, getDialect(), start, end);
			}
			catch (Exception e) {
				throw processException(e);
			}
	...
	public List<Author> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_AUTHOR.concat(AuthorModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Author author : findByGroupId(groupId)) {
			remove(author);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<com.liferay.portlet.simpleblog.model.Post> getPosts(long pk)
		throws SystemException {
	...
	public static final FinderPath FINDER_PATH_GET_POSTS = new FinderPath(com.liferay.portlet.simpleblog.model.impl.PostModelImpl.ENTITY_CACHE_ENABLED,
			com.liferay.portlet.simpleblog.model.impl.PostModelImpl.FINDER_CACHE_ENABLED,
			com.liferay.portlet.simpleblog.model.impl.PostImpl.class,
			com.liferay.portlet.simpleblog.service.persistence.PostPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"getPosts",
			new String[] {
	...
	static {
		FINDER_PATH_GET_POSTS.setCacheKeyGeneratorCacheName(null);
	}
	...
	public List<com.liferay.portlet.simpleblog.model.Post> getPosts(long pk,
		...
		List<com.liferay.portlet.simpleblog.model.Post> list = (List<com.liferay.portlet.simpleblog.model.Post>)FinderCacheUtil.getResult(FINDER_PATH_GET_POSTS,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					...
					sql = _SQL_GETPOSTS.concat(com.liferay.portlet.simpleblog.model.impl.PostModelImpl.ORDER_BY_SQL);
				}

				SQLQuery q = session.createSQLQuery(sql);

				q.addEntity("SimpleBlog_Post",
					com.liferay.portlet.simpleblog.model.impl.PostImpl.class);
				...
				list = (List<com.liferay.portlet.simpleblog.model.Post>)QueryUtil.list(q,
	...
	public static final FinderPath FINDER_PATH_GET_POSTS_SIZE = new FinderPath(com.liferay.portlet.simpleblog.model.impl.PostModelImpl.ENTITY_CACHE_ENABLED,
			com.liferay.portlet.simpleblog.model.impl.PostModelImpl.FINDER_CACHE_ENABLED,
			com.liferay.portlet.simpleblog.model.impl.PostImpl.class,
			com.liferay.portlet.simpleblog.service.persistence.PostPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	static {
		FINDER_PATH_GET_POSTS_SIZE.setCacheKeyGeneratorCacheName(null);
	}
	...
	public static final FinderPath FINDER_PATH_CONTAINS_POST = new FinderPath(com.liferay.portlet.simpleblog.model.impl.PostModelImpl.ENTITY_CACHE_ENABLED,
			com.liferay.portlet.simpleblog.model.impl.PostModelImpl.FINDER_CACHE_ENABLED,
			com.liferay.portlet.simpleblog.model.impl.PostImpl.class,
			com.liferay.portlet.simpleblog.service.persistence.PostPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"containsPost",
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.portlet.simpleblog.model.Author")));
	...
	private static final String _SQL_GETPOSTS = "SELECT {SimpleBlog_Post.*} FROM SimpleBlog_Post INNER JOIN SimpleBlog_Author ON (SimpleBlog_Author.authorId = SimpleBlog_Post.authorId) WHERE (SimpleBlog_Author.authorId = ?)";
	private static final String _SQL_GETPOSTSSIZE = "SELECT COUNT(*) AS COUNT_VALUE FROM SimpleBlog_Post WHERE authorId = ?";
	private static final String _SQL_CONTAINSPOST = "SELECT COUNT(*) AS COUNT_VALUE FROM SimpleBlog_Post WHERE authorId = ? AND postId = ?";
