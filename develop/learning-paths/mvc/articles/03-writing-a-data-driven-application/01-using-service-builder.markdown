...
data model so that it can be retrieved later to be processed or displayed. For
...
For more information about how Service Builder works, see the (not yet written)
Service Builder tutorial. For now, you'll jump right in and start creating your
application's service and persistence layers.
...
need to create that application first, or download it from
[here](https://github.com/liferay/liferay-docs/tree/6.2.x/develop/learning-paths/mvc/code/learning-sdk)
(not yet available). From here on, we'll assume you have Liferay IDE and your
