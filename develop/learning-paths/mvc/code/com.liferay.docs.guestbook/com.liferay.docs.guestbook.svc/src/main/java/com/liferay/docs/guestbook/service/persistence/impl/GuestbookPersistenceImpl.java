...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	public Guestbook fetchByPrimaryKey(Serializable primaryKey) {
		Guestbook guestbook = (Guestbook)entityCache.getResult(GuestbookModelImpl.ENTITY_CACHE_ENABLED,
	...
	private static final Guestbook _nullGuestbook = new GuestbookImpl() {
			@Override
			public Object clone() {
				return this;
			}
	...
	private static final CacheModel<Guestbook> _nullGuestbookCacheModel = new CacheModel<Guestbook>() {
			@Override
