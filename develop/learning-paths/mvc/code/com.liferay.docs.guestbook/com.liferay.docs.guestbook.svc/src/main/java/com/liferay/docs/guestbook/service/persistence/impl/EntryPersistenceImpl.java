...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	 ...
	 */
	@Override
	public List<Entry> findByEntryName(String name) {
	...
	public List<Entry> findByEntryName(String name, int start, int end,
		OrderByComparator<Entry> orderByComparator) {
		return findByEntryName(name, start, end, orderByComparator, true);
	}
	 ...
	 */
	@Override
	public void removeByEntryName(String name) {
	 ...
	 */
	@Override
	public int countByEntryName(String name) {
	...
	public List<Entry> findByG_N(long guestbookId, String name, int start,
		int end, OrderByComparator<Entry> orderByComparator) {
		return findByG_N(guestbookId, name, start, end, orderByComparator, true);
	}
	...
	public Entry updateImpl(Entry entry) {
		...
		if (isNew || !EntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				finderCache.removeResult(FINDER_PATH_COUNT_BY_ENTRYNAME, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ENTRYNAME,
					args);
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				finderCache.removeResult(FINDER_PATH_COUNT_BY_G_G_N, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_G_N,
					args);
