...
public class GuestbookPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(existingGuestbook.getStatus(),
			newGuestbook.getStatus());
		Assert.assertEquals(existingGuestbook.getStatusByUserId(),
			newGuestbook.getStatusByUserId());
		Assert.assertEquals(existingGuestbook.getStatusByUserName(),
			newGuestbook.getStatusByUserName());
		Assert.assertEquals(Time.getShortTimestamp(
				existingGuestbook.getStatusDate()),
	...
	protected OrderByComparator<Guestbook> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Guestbook", "uuid", true,
			...
			"name", true, "status", true, "statusByUserId", true,
	...
	public void testActionableDynamicQuery() throws Exception {
		...
		actionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Guestbook>() {
				@Override
