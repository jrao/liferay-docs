...
public class GuestbookLocalServiceUtil {
	...
	*/
	...
	public static java.lang.String getGuestbookLocalServiceString() {
		return getService().getGuestbookLocalServiceString();
	}
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(GuestbookLocalServiceUtil.class);

		_serviceTracker = new ServiceTracker<GuestbookLocalService, GuestbookLocalService>(bundle.getBundleContext(),
