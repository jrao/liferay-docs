...
public class GuestbookUtil {
	...
	* @return the matching guestbooks
	*/
	public static List<Guestbook> findByG_N(long groupId, java.lang.String name) {
	...
	* @return the range of matching guestbooks
	*/
	public static List<Guestbook> findByG_N(long groupId,
	...
	* @throws com.liferay.docs.guestbook.NoSuchGuestbookException if a matching guestbook could not be found
	*/
	public static Guestbook findByG_N_First(long groupId,
	...
	* @return the first matching guestbook, or <code>null</code> if a matching guestbook could not be found
	*/
	public static Guestbook fetchByG_N_First(long groupId,
		java.lang.String name, OrderByComparator<Guestbook> orderByComparator) {
		return getPersistence()
	...
	* @throws com.liferay.docs.guestbook.NoSuchGuestbookException if a matching guestbook could not be found
	*/
	public static Guestbook findByG_N_Last(long groupId, java.lang.String name,
		OrderByComparator<Guestbook> orderByComparator)
		throws com.liferay.docs.guestbook.exception.NoSuchGuestbookException {
	...
	* @return the last matching guestbook, or <code>null</code> if a matching guestbook could not be found
	*/
	public static Guestbook fetchByG_N_Last(long groupId,
		java.lang.String name, OrderByComparator<Guestbook> orderByComparator) {
	...
	* @throws com.liferay.docs.guestbook.NoSuchGuestbookException if a guestbook with the primary key could not be found
	*/
	public static Guestbook[] findByG_N_PrevAndNext(long guestbookId,
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(GuestbookUtil.class);

		_serviceTracker = new ServiceTracker<GuestbookPersistence, GuestbookPersistence>(bundle.getBundleContext(),
