...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(guestbook.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.guestbook.model.Foo"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(guestbook.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.guestbook.model.Foo"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(guestbook.service.util.PropsUtil.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(guestbook.service.util.PropsUtil.get(
