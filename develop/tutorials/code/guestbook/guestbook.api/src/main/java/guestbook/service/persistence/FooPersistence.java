...
public interface FooPersistence extends BasePersistence<Foo> {
	...
	* @throws guestbook.NoSuchFooException if a matching foo could not be found
	*/
	...
	* @throws guestbook.NoSuchFooException if a foo with the primary key could not be found
	*/
	...
	*/
	...
	/**
	* Returns the foo where uuid = &#63; and groupId = &#63; or throws a {@link guestbook.NoSuchFooException} if it could not be found.
	*
	* @param uuid the uuid
	...
	* @throws guestbook.NoSuchFooException if a foo with the primary key could not be found
	*/
	public Foo remove(long fooId) throws guestbook.exception.NoSuchFooException;

	public Foo updateImpl(Foo foo);

	/**
	* Returns the foo with the primary key or throws a {@link guestbook.NoSuchFooException} if it could not be found.
	*
	* @param fooId the primary key of the foo
	* @return the foo
	* @throws guestbook.NoSuchFooException if a foo with the primary key could not be found
